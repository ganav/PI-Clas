...
dir_A='G:\\projects\\paper 18\\source\\data\\visible dataset divided\\db2\\deblur_orig\\/*.png'
dir_B='G:\\projects\\paper 18\\source\\data\\visible dataset divided\\db2\\deblur_blur\\/*.png'
dir_C='G:\\projects\\paper 18\\source\\data\\visible dataset divided\\db2\\deblur_result\\'

img_files = glob.glob(dir_B)

#model, model modified, model deblurGAN orig
model = load_model('./model db2/model200.h5', custom_objects={'ReflectionPadding2D': ReflectionPadding2D})
